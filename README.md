...
The public demo allows visitors to explore the administrator dashboard, but blocks changes to products, categories, tables, QR codes, and order statuses. Local development remains fully editable with `DEMO_MODE=false`, as shown in the example environment file.
